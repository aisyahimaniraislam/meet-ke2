...
public class Main {
    ...
    public static void main(String[] args) {
        // Mengisi stok buku
        bookList[0] = new Book("B001", "tenggelamnya kapal van den wich", 5, "sukron");
        bookList[1] = new Book("B002", "avatar aang", 10, "wendi botak");
        bookList[2] = new Book("B003", "dilan 1991", 8, "Sugiono");
